using DynamicDataTestProject.BLL;
...
namespace DynamicDataTestProject
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<MyProgressDatabase>());
            ...
            DefaultModel.RegisterContext(
                new EFDataModelProvider(() => new MyProgressDatabase()),
